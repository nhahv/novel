...
@section('content')
    <div id="history">
        <h2 class="title">@lang('read_history')</h2>
        <ul class="history-ul"></ul>
    </div>
    <!-- left -->
    <div id="left">
        <!-- Truyen hot -->
        <h2 class="title">@lang('commons.hot_novels')</h2>
        <div class="l-grid">
            <div class="e-wrapper">
                ...
                <div class="element">
                    ...
                    <div class="content">
                        ...
                        <span class="e-view">HOT: {{ $novel->hot }}</span>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <!--/ Truyen hot -->
        <!-- truyen moi cap nhat -->
        <h1 class="title"><a href="/" title="{{ trans('commons.recently_updated') }}" >{{ trans('commons.recently_updated') }}</a></h1>
